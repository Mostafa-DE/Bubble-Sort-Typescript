...
var CharactersCollection = /** @class */ (function (_super) {
    ...
    CharactersCollection.prototype.compare = function (leftIndx, rightIndx) {
        return (this.data[leftIndx].toLowerCase() > this.data[rightIndx].toLowerCase());
    };
    CharactersCollection.prototype.swap = function (leftIndx, rightIndx) {
        var characters = this.data.split("");
        var leftHand = characters[leftIndx];
