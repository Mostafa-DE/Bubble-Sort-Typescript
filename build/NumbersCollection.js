...
var NumbersCollection = /** @class */ (function (_super) {
    ...
    NumbersCollection.prototype.compare = function (leftIndx, rightIndx) {
        return this.data[leftIndx] > this.data[rightIndx];
    };
    NumbersCollection.prototype.swap = function (leftIndx, rightIndx) {
        var leftHand = this.data[leftIndx];
